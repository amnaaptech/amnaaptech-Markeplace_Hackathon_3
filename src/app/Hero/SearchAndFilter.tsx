...
//   // Unique filter values from products
//   // const categories = [...new Set(products?.map((p) => p.category).filter(Boolean))];

//   const categories = [...new Set(
//     products
//       .map((p) => {
//         if (typeof p.category === "object" && "_ref" in p.category) {
//           return p.category._ref; // Sanity reference case
//         }
//         return p.category; // String case
//       })
//       .filter((cat): cat is string => Boolean(cat)) // Ensure it's a string
//   )];
...
//   return (
//     <div className="p-4 bg-white shadow-md rounded-lg flex flex-wrap gap-4 items-center">
//       {/* Search Bar */}
//       <input
//         type="text"
...
// </select>
//       {/* Price Filter */}
//       <select onChange={(e) => setPriceRange(e.target.value)} className="border px-3 py-2 rounded">
...
//       {/* Sorting */}
//       <select onChange={(e) => setSortBy(e.target.value)} className="border px-3 py-2 rounded">
...
//       <button onClick={applyFilters} className="bg-[#2A254B] text-white px-4 py-2 rounded">
//         Apply Filters
//       </button>
//     </div>
//   );
